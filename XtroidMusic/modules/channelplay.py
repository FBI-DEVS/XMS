# XtroidMusic (Telegram bot project)
...
from XtroidMusic.modules.play import generate_cover
from XtroidMusic.modules.play import arq
from XtroidMusic.modules.play import cb_admin_check
from XtroidMusic.modules.play import transcode
from XtroidMusic.modules.play import convert_seconds
from XtroidMusic.modules.play import time_to_seconds
from XtroidMusic.modules.play import changeImageSize
from XtroidMusic.config import BOT_NAME as bn
from XtroidMusic.config import DURATION_LIMIT
from XtroidMusic.config import UPDATES_CHANNEL as updateschannel
from XtroidMusic.config import que
from XtroidMusic.function.admins import admins as a
from XtroidMusic.helpers.errors import DurationLimitError
from XtroidMusic.helpers.decorators import errors
from XtroidMusic.helpers.admins import get_administrators
from XtroidMusic.helpers.channelmusic import get_chat_id
from XtroidMusic.helpers.decorators import authorized_users_only
from XtroidMusic.helpers.filters import command, other_filters
from XtroidMusic.helpers.gets import get_file_name
from XtroidMusic.services.callsmusic import callsmusic
from XtroidMusic.services.callsmusic.callsmusic import client as USER
from XtroidMusic.services.converter.converter import convert
from XtroidMusic.services.downloaders import youtube
from XtroidMusic.services.queues import queues
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add XtroidMusicbot to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
